STATUS: FROZEN FOR CURRENT BUILD BOUNDARY  
DISPOSITION: GOVERNING  
ROLE: Constitutive non-collapse constraints  
AUTHORITY: Ratified build boundary  
CHANGE ROUTE: Explicit architecture decision / human authorization

# Constitutive Invariants

Implementation SHALL preserve recoverability of these distinctions:
...
- operational classification ≠ ontological exhaustion
- operational closure ≠ metaphysical closure
